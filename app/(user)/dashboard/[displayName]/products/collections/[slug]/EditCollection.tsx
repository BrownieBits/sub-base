...
export default function Edit(props: {
  ...
  async function onSubmit() {
    ...
    props.revalidate();
    push(`/dashboard/${props.displayName}/products/collections`);
  }
    ...
    <section>
      <section className="flex w-full justify-between items-center px-[15px] pt-[30px] gap-[15px]">
        <Button variant="link" asChild className="px-0 py-0 h-auto">
          <Link href={`/dashboard/${props.displayName}/products/collections`}>
            <FontAwesomeIcon className="icon mr-[5px]" icon={faChevronLeft} />
            Collections
          </Link>
        </Button>
      </section>
      <section className="flex w-full justify-between items-center px-[15px] pt-[10px] pb-[10px] gap-[15px]">
      ...
      <section className="flex w-full justify-between items-center px-[15px] pb-[15px] gap-[15px]">
        <Link
          href={`http://localhost:3000/creator/${props.displayName}/collection/${props.id}`}
        >
          Go to Collection
        </Link>
      </section>
      <Separator className="mb-[15px]" />
      <section className="flex flex-col md:flex-row justify-center px-[15px] py-[30px] w-full gap-[30px]">
        <section className="">
