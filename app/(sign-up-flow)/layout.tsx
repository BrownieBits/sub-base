...
export default async function SignUpFlowLayout({
      ...
      <main className="flex min-h-svh width-full">
        {data.items.length === 0 ? (
          ...
          <section
            ...
            style={{
              backgroundImage: `url('https:${data.items[0].fields.banner.fields.file.url}')`,
            }}
          ></section>
        )}
        <section className="flex flex-col flex-1 justify-center items-center p-[30px]">
          <Link href="/" aria-label="Spring by Amaze">
            <svg
              className="fill-foreground h-[56px] mb-[30px]"
              viewBox="0 0 156 48"
